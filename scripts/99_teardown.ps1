...
if ($dep) {
    az cognitiveservices account deployment delete --name $env:FOUNDRY_ACCOUNT --resource-group $rg --deployment-name chat-model
    Write-Host "chat-model deployment deleted"
